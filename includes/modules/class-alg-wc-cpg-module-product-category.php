...
if ( ! class_exists( 'Alg_WC_CPG_Module_User_Product_Category' ) ) :

class Alg_WC_CPG_Module_User_Product_Category extends Alg_WC_CPG_Module {
...
return new Alg_WC_CPG_Module_User_Product_Category();
