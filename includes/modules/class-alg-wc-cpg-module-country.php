...
class Alg_WC_CPG_Module_Country extends Alg_WC_CPG_Module {
	...
	function get_default_notice( $submodule ) {
		return __( '"%gateway_title%" is not available for your country.', 'conditional-payment-gateways-for-woocommerce' ); // phpcs:ignore WordPress.WP.I18n.MissingTranslatorsComment
	}
